...
static const char *fonts[] = {"JetBrains Mono Nerd Font:size=14:antialias=true:autohint=true"};
static const char dmenufont[] = "JetBrains Mono Nerd Font:size=14";

#include "colors-wal-dwm.h"

/* tagging */
static const char *tags[] = {" 󰣇 ", "  ", " 󰈙 ", "   ", " 󰙯 "};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_s ,spawn, SHCMD("scrot ~/Pictures/%Y-%m-%d-%T-scrot.png")},
